...
int start() {
   ...
   ObjectSetText("zagolovok_Label", "ILAN_TURBO_BETA_v4.5.1 by Geret   ", 15, gs_calibri_112, LawnGreen);
   ...
   ObjectSetText("zagolovok1_Label", "____________________________________________", 15, gs_calibri_112, Red);
   ...
   ObjectSetText("Balans_Label", "Баланс счета    " + l_dbl2str_16, 15, gs_calibri_112, Yellow);
   ...
   ObjectSetText("sr_Label", "Свободные средства    " + l_dbl2str_24, 15, gs_calibri_112, Yellow);
   ...
   ObjectSetText("orders_Label", "Количество колен ведущей серии            " + ls_32, 15, gs_calibri_112, Yellow);
   ...
   ObjectSetText("orders1_Label", "Количество колен серии сопровождения            " + ls_40, 15, gs_calibri_112, Yellow);
   ...
   ObjectSetText("zagolovok2_Label", "____________________________________________", 15, gs_calibri_112, Red);
